...
class TestPartitions(unittest.TestCase):
    ...
    def testEqualNeighbor(self):
        ...
        equalNeighbor(self.im8_1, self.im8_2, 1, grid=SQUARE)
    ...
    def testNonEqualNeighbor(self):
        ...
        drawSquare(self.im8_1, (0,h/2,w/2-1,h-1), 150)
        drawSquare(self.im8_1, (w/2,h/2,w-1,h-1), 200)
        nonEqualNeighbor(self.im8_1, self.im8_2, 1, grid=SQUARE)
        self.im8_3.reset()
...
def getSuite():
    return unittest.TestLoader().loadTestsFromTestCase(TestPartitions)
