...
class TestGeodesy3D(unittest.TestCase):
    ...
    def testBuild3D_32(self):
        ...
        for d in getDirections3D()[::3]:
            ...
            linearDilate3D(self.im32_1, self.im32_1, d, 4)
    ...
    def testDualBuild3D_32(self):
        ...
        for d in getDirections3D()[::3]:
            ...
            self.im32_3.setPixel(528, (32,32,32))
            linearErode3D(self.im32_1, self.im32_1, d, 4)
...
def getSuite():
    return unittest.TestLoader().loadTestsFromTestCase(TestGeodesy3D)
