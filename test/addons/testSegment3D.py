...
class TestSegment3D(unittest.TestCase):
    ...
    def testDepthAcceptation(self):
        ...
        self.assertRaises(MambaError, watershedSegment3D, self.im32_1, self.im32_2)
        ...
        self.assertRaises(MambaError, basinSegment3D, self.im32_1, self.im32_2)
        ...
        self.assertRaises(MambaError, label3D, self.im8_1, self.im32_2)
        self.assertRaises(MambaError, label3D, self.im32_1, self.im1_2)
        self.assertRaises(MambaError, label3D, self.im32_1, self.im8_2)
        self.assertRaises(MambaError, label3D, self.im32_1, self.im32_2)
...
def getSuite():
    return unittest.TestLoader().loadTestsFromTestCase(TestSegment3D)
