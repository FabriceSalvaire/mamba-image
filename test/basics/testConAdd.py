...
class TestConAdd(unittest.TestCase):
    ...
    def testComputation_8_8(self):
        ...
        for i in range(256):
            ...
            self.assertTrue(self.im8_2.getPixel((0,0))==i)
        ...
        self.assertTrue(self.im8_2.getPixel((0,0))==1)
    ...
    def testComputation_8_32(self):
        ...
        for i in range(1000):
            ...
            self.assertTrue(self.im32_2.getPixel((0,0))==i)
    ...
    def testComputation_32_32(self):
        ...
        for i in range(1000):
            ...
            self.assertTrue(self.im32_2.getPixel((0,0))==v1+v2)
        

def getSuite():
    return unittest.TestLoader().loadTestsFromTestCase(TestConAdd)
