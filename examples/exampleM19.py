...
def laplacian(imIn, imOut, n=1, se=mC.DEFAULT_SE):
    """
    ...
    mC.halfGradient(imIn, imWrk1, "extern", n=n, se=se)
    mC.halfGradient(imIn, imWrk2, "intern", n=n, se=se)
